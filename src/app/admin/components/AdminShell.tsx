...
export default function AdminShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="relative min-h-dvh bg-[#0B1120] lg:flex">
      <aside className="flex items-center justify-between gap-3 border-b border-white/10 bg-[#0B1120] px-4 py-4 lg:sticky lg:top-0 lg:h-dvh lg:w-64 lg:shrink-0 lg:flex-col lg:items-stretch lg:justify-start lg:border-b-0 lg:border-r lg:px-5 lg:py-8">
        ...
        <nav data-tour="nav" className="flex items-center gap-1 lg:mt-10 lg:flex-col lg:items-stretch lg:gap-1">
